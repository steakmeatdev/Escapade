    ...
    <div className="h-[48px] lg:h-[64] flex flex-row items-center justify-between border rounded-full ">
      <div className="hidden lg:block">
        <div className="cursor-pointer flex flex-row items-center justify-between">
          <div className="w-[250px] h-[48px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
          ...
          <div className="cursor-pointer h-[48px] px-8 flex flex-col justify-center rounded-full hover:bg-gray-100">
            ...
            <p className="text-sm">Added dates</p>
          </div>
      ...
      <div className="p-2">
        <div className="cursor-pointer p-2 bg-escapade hover:bg-escapade-dark transition rounded-full text-white">
          <svg
            viewBox="0 0 32 32"
            style={{
              display: "block",
